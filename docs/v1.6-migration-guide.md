...
This guide helps you upgrade your Quattrex P2P platform to version 1.6 with the new payout system.
...
2. Finance page now uses the new purple color scheme (#530FAD)
