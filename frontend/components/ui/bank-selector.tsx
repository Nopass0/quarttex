...
const banks: Bank[] = [
  { code: 'SBERBANK', name: 'Сбербанк', logo: '💜', bgColor: 'bg-purple-50' },
  ...
  { code: 'ROSSELKHOZBANK', name: 'Россельхозбанк', logo: '🌾', bgColor: 'bg-purple-50' },
  { code: 'URALSIB', name: 'Уралсиб', logo: '💎', bgColor: 'bg-blue-50' },
  { code: 'LOKOBANK', name: 'Локо-Банк', logo: '🚂', bgColor: 'bg-red-50' },
  { code: 'AKBARS', name: 'Ак Барс Банк', logo: '🐆', bgColor: 'bg-purple-50' },
  ...
  { code: 'BBRBANK', name: 'ББР Банк', logo: '🌟', bgColor: 'bg-purple-50' },
  ...
  { code: 'SINARA', name: 'Синара', logo: '🚄', bgColor: 'bg-purple-50' },
  ...
  { code: 'DOLINSK', name: 'Долинск', logo: '🏞️', bgColor: 'bg-purple-50' },
  { code: 'SOVCOMBANK', name: 'Совкомбанк', logo: '🎪', bgColor: 'bg-red-50' },
  { code: 'ROSBANK', name: 'Росбанк', logo: '🌹', bgColor: 'bg-purple-50' },
