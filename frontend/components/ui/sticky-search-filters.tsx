...
export function StickySearchFilters({
  ...
  return (
    <div 
      ref={stickyRef}
      className={cn(
        "sticky bg-white dark:bg-[#0f0f0f] pb-3 md:pb-4 -mx-4 md:-mx-6 px-4 md:px-6 pt-2 shadow-sm dark:shadow-[purple-900/30] z-10",
        className
      )}
      style={{ 
        top: `${stickyTop}px`,
      ...
      <div className="flex flex-col sm:flex-row gap-2">
        ...
        <div className="relative flex-1">
          ...
          <Input
            ...
            className="pl-10 border h-10 md:h-12 text-sm md:text-base border-gray-300 dark:border-purple-900/30 rounded-lg"
          />
        </div>
            ...
            >
              <div className="space-y-4">
                ...
                <div className="flex gap-2 pt-2">
                  ...
                  <Button
                    size="sm"
                    className="flex-1 h-12 bg-[purple-600] hover:bg-[purple-600]/90"
