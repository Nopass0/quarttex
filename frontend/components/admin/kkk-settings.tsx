        ...
        <div className="space-y-2">
          ...
          <div className="flex gap-2 items-center">
            ...
            {rapiraKkk && currentRapiraRate && (
              <div className="flex-1 min-w-[200px] p-3 bg-gradient-to-r from-purple-50 to-violet-50 dark:from-purple-900/10 dark:to-violet-900/10 rounded-lg border-2 border-purple-500 dark:border-purple-600">
                <p className="text-sm font-medium text-gray-900 dark:text-gray-200">
                  Новый курс: <span className="text-lg font-bold text-[#530FAD] dark:text-purple-400">
          ...
          {currentRapiraRate && (
            <div className="mt-3 p-3 bg-gradient-to-r from-purple-50 to-violet-50 dark:from-purple-900/10 dark:to-violet-900/10 rounded-lg border-2 border-purple-500 dark:border-purple-600">
              <p className="text-sm font-medium text-gray-900 dark:text-gray-200">
                Текущий курс Rapira: <span className="text-lg font-bold text-[#530FAD] dark:text-purple-400">{currentRapiraRate.toFixed(2)} ₽/USDT</span>
              </p>
            </div>
          )}
        </div>
