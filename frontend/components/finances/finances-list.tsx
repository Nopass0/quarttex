...
export function FinancesList() {
  ...
  const getStatusBadge = (status: string) => {
    const statusConfig: any = {
      ...
      READY: { label: "Готово", color: "bg-[purple-600]/10 text-[purple-600] border-[purple-600]/20 dark:bg-[purple-600]/20 dark:text-[purple-600] dark:border-[purple-600]/30" },
  ...
  const getTypeBadge = (type: string) => {
    return type === "IN" ? "bg-[purple-600]/10 text-[purple-600] dark:bg-[purple-600]/20 dark:text-[purple-600]" : "bg-red-50 text-red-600 dark:bg-red-900/30 dark:text-red-400"
  }
  ...
  return (
    <div className="space-y-6">
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
        <Card className="p-6 dark:bg-purple-900/30 dark:border-gray-700">
          <div className="flex items-center justify-between mb-2">
            ...
            <Button 
              variant="link" 
              className="text-[purple-600] dark:text-[purple-600] p-0 h-auto text-sm"
        ...
        <Card className="p-6 dark:bg-purple-900/30 dark:border-gray-700">
          ...
          <div className="text-2xl font-bold text-[purple-600] dark:text-[purple-600]">+{financeStats.totalProfit.toLocaleString('ru-RU')} {financeStats.currency}</div>
        </Card>
      </div>
        ...
        <div className="flex flex-col sm:flex-row flex-wrap items-stretch sm:items-center gap-4">
          <div className="flex-1 min-w-[200px]">
            <div className="relative">
              <Search className="absolute left-3 top-1/2 transform -translate-y-1/2 text-[purple-600] dark:text-[purple-600] h-4 w-4" />
              <Input
          ...
          <div className="flex flex-col sm:flex-row gap-2 w-full sm:w-auto">
            ...
            <Select value={dateFilter} onValueChange={setDateFilter}>
              <SelectTrigger className="w-full sm:w-[180px] dark:bg-[#0f0f0f] dark:border-gray-600 dark:text-[#eeeeee]">
                <Calendar className="mr-2 h-4 w-4 text-[purple-600] dark:text-[purple-600]" />
          ...
          <div className="flex gap-2 w-full sm:w-auto">
            <Button variant="outline" className="flex-1 sm:flex-initial dark:border-gray-600 dark:text-gray-300 dark:hover:bg-[purple-900/30]/50">
              <Filter className="mr-2 h-4 w-4 text-[purple-600] dark:text-[purple-600]" />
              <span className="hidden sm:inline">Фильтры</span>
            </Button>
            
            <Button variant="outline" className="flex-1 sm:flex-initial dark:border-gray-600 dark:text-gray-300 dark:hover:bg-[purple-900/30]/50">
              <Download className="mr-2 h-4 w-4 text-[purple-600] dark:text-[purple-600]" />
      ...
      {/* Transactions Table */}
      <Card className="overflow-hidden dark:bg-purple-900/30 dark:border-gray-700">
        <Table>
          <TableHeader>
          ...
          <TableBody>
            {filteredTransactions.length === 0 ? (
              ...
              filteredTransactions.map((transaction) => {
                ...
                return (
                  <TableRow key={transaction.id} className="hover:bg-gray-50/50 dark:hover:bg-[purple-900/30]/30">
                      ...
                      <DropdownMenu>
                        <DropdownMenuTrigger asChild>
                          <Button
                            variant="ghost"
                            size="sm"
                            className="h-8 w-8 p-0 dark:hover:bg-[purple-900/30]/50"
                          >
                            <MoreVertical className="h-4 w-4 text-[purple-600] dark:text-[purple-600]" />
                          </Button>
                        </DropdownMenuTrigger>
                        <DropdownMenuContent align="end" className="w-48 dark:bg-purple-900/30 dark:border-gray-700">
                          <DropdownMenuItem className="dark:hover:bg-[purple-900/30]/50">
                            <Eye className="mr-2 h-4 w-4 text-[purple-600] dark:text-[purple-600]" />
                            Подробнее
                          </DropdownMenuItem>
                        </DropdownMenuContent>
                      </DropdownMenu>
            ...
            {!isAddingNewWallet ? (
              <>
                <div>
                  ...
                  <Button
                    variant="link"
                    className="text-[purple-600] p-0 h-auto text-sm mt-2"
