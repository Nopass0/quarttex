      ...
      <DialogContent className="max-w-md">
        <DialogHeader>
          <DialogTitle className="flex items-center gap-2">
            <ArrowDownRight className="h-5 w-5" style={{ color: 'purple-600' }} />
          ...
          {step === 1 && (
            <div className="space-y-4">
              ...
              <Button 
                ...
                className="w-full bg-[purple-600] hover:bg-[purple-600]/90 dark:bg-[purple-600] dark:hover:bg-[purple-600]/90 text-white disabled:opacity-50 disabled:cursor-not-allowed"
              >
                Продолжить
              </Button>
            </div>
            ...
            <div className="space-y-4">
              ...
              <div>
                ...
                <div className="mt-2 flex items-center gap-2">
                  ...
                  >
                    {copiedAddress ? (
                      <CheckCircle2 className="h-4 w-4" style={{ color: 'purple-600' }} />
                    ) : (
              ...
              <div className="flex gap-2">
                ...
                <Button
                  ...
                  className="flex-1 bg-[purple-600] hover:bg-[purple-600]/90 dark:bg-[purple-600] dark:hover:bg-[purple-600]/90 text-white disabled:opacity-50 disabled:cursor-not-allowed"
                >
                  {loading ? (
                    <>
          ...
          {step === 3 && (
            <div className="space-y-4 text-center">
              <div className="p-6 rounded-lg" style={{ backgroundColor: 'rgba(0, 96, 57, 0.05)' }}>
                <CheckCircle2 className="h-12 w-12 mx-auto mb-4" style={{ color: 'purple-600' }} />
              ...
              <div className="flex gap-2">
                ...
                <Button
                  onClick={handleReset}
                  className="flex-1 bg-[purple-600] hover:bg-[purple-600]/90 dark:bg-[purple-600] dark:hover:bg-[purple-600]/90 text-white"
                >
                  Новое пополнение
                </Button>
              </div>
