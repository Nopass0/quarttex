  ...
  return (
    <div className="space-y-6">
              ...
              <PopoverTrigger asChild>
                <Button variant="outline" size="sm" className="text-xs">
                  ...
                  {period === "today"
                    ...
                    ? "за год"
                    : "за сегодня"}
                  <ChevronDown className="ml-1 h-3 w-3 text-[#530FAD] dark:text-[#7c3aed] dark:drop-shadow-[0_0_6px_rgba(124,58,237,0.4)] " />
                </Button>
              </PopoverTrigger>
              <PopoverContent
                className="w-48 p-0"
        ...
        additionalButtons={
          <Popover>
            <PopoverTrigger asChild>
              ...
              >
                <ArrowUpDown className="h-3.5 w-3.5 md:h-4 md:w-4 text-[#530FAD] dark:text-[#7c3aed] dark:drop-shadow-[0_0_6px_rgba(124,58,237,0.4)]" />
      ...
      >
            ...
            >
              ...
              <div className="max-h-64 overflow-auto">
                <Button
                  ...
                  size="default"
                  className={cn(
                    "w-full justify-start h-12 hover:bg-purple-50 dark:hover:bg-purple-900/20 hover:text-[#530FAD] dark:text-[#7c3aed] dark:drop-shadow-[0_0_6px_rgba(124,58,237,0.4)] ",
                    filterStatus === "all" &&
                      "text-[#530FAD] dark:text-[#7c3aed] dark:drop-shadow-[0_0_6px_rgba(124,58,237,0.4)]  bg-purple-50 dark:bg-purple-900/20"
                  )}
        ...
        <div className="space-y-2">
          <div className="flex items-center gap-2">
            <Smartphone className="h-4 w-4 text-[#530FAD] dark:text-[#7c3aed] dark:drop-shadow-[0_0_6px_rgba(124,58,237,0.4)]" />
          ...
          <>
            {filteredTransactions.map((transaction) => {
              ...
              const getStatusBadgeColor = () => {
                switch (transaction.status) {
                  case "READY":
                    return "bg-purple-100 dark:bg-purple-900/30 text-purple-700  border-purple-200 dark:border-purple-800";
                  case "CREATED":
                  case "IN_PROGRESS":
              ...
              {selectedTransaction && !showRequisiteDetails && (
                <>
                  ...
                  <div className="px-6 py-6 text-center">
                    ...
                    <div className="mb-4 flex justify-center">
                      {selectedTransaction.status === "READY" ? (
                        <div className="w-20 h-20 rounded-3xl bg-purple-100 dark:bg-purple-900/30 flex items-center justify-center">
                          <CheckCircle2 className="h-10 w-10 text-[#530FAD] dark:text-[#7c3aed] " />
                        </div>
                    ...
                    {/* Amount */}
                    <div className="mb-1">
                      <span className="text-3xl font-bold text-[#530FAD] dark:text-[#7c3aed] ">
                  ...
                  <div className="px-6 pb-4 space-y-3">
                    ...
                    {selectedTransaction.method && (
                      <div className="pt-3 border-t dark:border-gray-700">
                        <Button
                          variant="ghost"
                          className="w-full p-3 h-auto justify-between hover:bg-purple-50/30 dark:hover:bg-gray-700 -mx-3"
                          onClick={() => {
                        ...
                        >
                          <div className="flex items-center gap-3">
                            <div className="w-10 h-10 rounded bg-purple-100/40 dark:bg-purple-900/25 flex items-center justify-center">
                              <Smartphone className="h-5 w-5 text-[#530FAD] dark:text-[#7c3aed] dark:drop-shadow-[0_0_6px_rgba(124,58,237,0.4)] " />
                            </div>
                            <div className="text-left">
                              <p className="text-sm font-medium dark:text-white">
                                {devices.find(
                        ...
                        >
                          <div className="flex items-center gap-3">
                            <div className="w-10 h-10 rounded bg-purple-100 dark:bg-purple-900/30 flex items-center justify-center">
                              <MessageSquare className="h-5 w-5 text-[#530FAD] dark:text-[#7c3aed] " />
                            </div>
                    ...
                    <div className="pt-4 space-y-3">
                      ...
                      <div className="space-y-2">
                        ...
                        <Button
                          ...
                          onClick={() => toast.info("Функция в разработке")}
                        >
                          <Eye className="h-4 w-4 mr-2 text-[#530FAD] dark:text-[#7c3aed] dark:drop-shadow-[0_0_6px_rgba(124,58,237,0.4)] " />
                        ...
                        <Button
                          ...
                          onClick={() => toast.info("Функция в разработке")}
                        >
                          <CreditCard className="h-4 w-4 mr-2 text-[#530FAD] dark:text-[#7c3aed] dark:drop-shadow-[0_0_6px_rgba(124,58,237,0.4)] " />
