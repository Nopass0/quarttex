      ...
      <div key={item.title}>
        <button
          ...
          className={cn(
            ...
            isActive
              ? "bg-[#530FAD]/10 text-[#530FAD] font-medium border-l-4 border-[#530FAD] -ml-[1px] dark:bg-[#7c3aed]/10 dark:text-[#7c3aed] dark:border-[#7c3aed]"
        ...
        >
          ...
          >
            <item.icon className="h-5 w-5 text-[#530FAD] dark:text-[#7c3aed]" />
          </div>
        ...
        {variant === "agent" && agent && (
          <div className="p-4 border-b border-gray-100 dark:border-[#29382f]">
            <div className="space-y-1">
              ...
              <div className="text-xs text-[#530FAD] dark:text-[#7c3aed] font-medium">
            ...
            <div className="space-y-2">
              ...
              <div className="flex items-center justify-between p-3 bg-gradient-to-r from-[#530FAD]/10 to-[#530FAD]/5 rounded-lg">
                <div>
                  ...
                  <div className="text-lg font-bold text-[#530FAD] dark:text-[#7c3aed]">
                ...
                <Button
                  size="sm"
                  variant="outline"
                  className="border-[#530FAD] text-[#530FAD] hover:bg-[#530FAD] hover:text-white"
                  onClick={() => {
