  ...
  return (
    <div className="space-y-6">
      ...
      <div className="space-y-4">
        {folders.length === 0 ? (
          <Card className="bg-purple-50/10 p-8 text-center text-gray-500 dark:text-gray-400 dark:bg-purple-800/60 dark:border-gray-700">
          ...
          folders.map((folder) => {
            ...
            return (
              <Card key={folder.id} className="overflow-hidden dark:bg-purple-800/60 dark:border-gray-700">
                <Collapsible open={isExpanded} onOpenChange={() => toggleFolder(folder.id)}>
                  <div className="p-4 hover:bg-purple-50/30 dark:hover:bg-purple-800/60/30 transition-colors">
                    <div className="flex items-center justify-between">
                      ...
                      <div className="flex items-center gap-2">
                        <Button
                          ...
                          className="dark:border-gray-600 dark:hover:bg-purple-800/60/50"
                        >
                          <PlayCircle className="h-4 w-4 mr-1 text-[#530FAD] dark:text-[#7c3aed] dark:text-[#530FAD] dark:text-[#7c3aed]" />
                          Запустить все
                        </Button>
                        <Button
                          variant="outline"
                        ...
                        <Button
                          ...
                          className="dark:hover:bg-purple-800/60/50"
                        >
                      ...
                      {folder.requisites.length === 0 ? (
                        ...
                        <div className="divide-y dark:divide-gray-700">
                          {folder.requisites.map((requisite) => (
                            <div key={requisite.id} className="p-4 hover:bg-purple-50/30 dark:hover:bg-purple-800/60/30">
                              <div className="flex items-center justify-between">
        ...
        <Card className="bg-purple-50/10 p-4 dark:bg-purple-800/60 dark:border-gray-700">
          ...
          <div className="space-y-2">
            {getUnassignedRequisites().map((requisite) => (
              <div key={requisite.id} className="flex items-center justify-between p-3 bg-purple-50/30 dark:bg-purple-800/60/50 rounded-lg">
                <div className="flex items-center gap-3">
      ...
      <Dialog open={createFolderModal.isOpen} onOpenChange={createFolderModal.setOpen}>
        <DialogContent className="dark:bg-purple-800/60 dark:border-gray-700">
          <DialogHeader>
              ...
              <div className="border dark:border-gray-600 rounded-lg max-h-60 overflow-y-auto p-3 space-y-2 dark:bg-[#0f0f0f]">
                {requisites.length === 0 ? (
                  ...
                  requisites.map((requisite) => (
                    <label
                      key={requisite.id}
                      className="flex items-center gap-3 p-2 hover:bg-purple-50/30 dark:hover:bg-purple-800/60/30 rounded cursor-pointer"
                    >
                      <Checkbox
                        ...
                        className="dark:border-gray-600 dark:data-[state=checked]:bg-purple-800/60 dark:data-[state=checked]:border-[#2d6a42]"
                      />
                      <CreditCard className="h-4 w-4 text-gray-400 dark:text-gray-500" />
          ...
          <DialogFooter>
            <Button 
              ...
              className="dark:border-gray-600 dark:text-gray-300 dark:hover:bg-purple-800/60/50"
            >
              Отмена
            </Button>
            <Button
