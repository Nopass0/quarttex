    ...
    <div className="space-y-6">
      ...
      <div className="grid gap-6 md:grid-cols-2 lg:grid-cols-4">
        <Card>
          ...
          <CardContent>
            <div className="text-2xl font-bold text-[purple-600]">{profileData.agent.commissionRate}%</div>
          </CardContent>
        </Card>
        ...
        <Card>
          ...
          <CardContent>
            <div className="flex items-center gap-2">
              ...
              <span className="text-2xl font-bold text-[purple-600]">${formatAmount(profileData.totalEarnings || 0)}</span>
            </div>
          </CardContent>
        </Card>
      </div>
