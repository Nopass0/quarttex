...
function ModalTestContent() {
  ...
  return (
    <div className="container mx-auto p-6 max-w-4xl">
      ...
      <Card className="bg-purple-50/10 p-6 mb-6 dark:bg-purple-800/60 dark:border-gray-700">
      ...
      <NavigableDialog open={settingsModal.isOpen} onOpenChange={settingsModal.setOpen}>
        <NavigableDialogContent className="dark:bg-purple-800/60 dark:border-gray-700">
          <NavigableDialogHeader>
      ...
      <NavigableDialog open={documentModal.isOpen} onOpenChange={documentModal.setOpen}>
        <NavigableDialogContent className="dark:bg-purple-800/60 dark:border-gray-700">
          ...
          <div className="space-y-4 py-4">
            <Card className="bg-purple-50/10 p-4 dark:bg-[#0f0f0f] dark:border-gray-700">
            ...
            <div className="space-y-2">
              <Button 
                variant="outline" 
                className="w-full justify-start dark:border-gray-600 dark:text-gray-300 dark:hover:bg-purple-800/60/50"
          ...
          <NavigableDialogFooter>
            <Button 
              ...
              className="w-full bg-[#530FAD] hover:bg-[#530FAD]/90 dark:bg-purple-800/60 dark:hover:bg-purple-800/60/90"
            >
              Close
            </Button>
          </NavigableDialogFooter>
      ...
      <Card className="bg-purple-50/10 p-6 dark:bg-purple-800/60 dark:border-gray-700">
        ...
        <ul className="space-y-2 text-gray-600 dark:text-gray-400">
          <li className="flex items-start gap-2">
            ...
            <span>Opening a modal adds <code className="text-sm bg-purple-100/40 dark:bg-[#0f0f0f] px-1 rounded">?modal=modalName</code> to the URL</span>
          </li>
          <li className="flex items-start gap-2">
            <ArrowRight className="h-4 w-4 mt-0.5 text-[#006039] dark:text-[#2d6a42]" />
