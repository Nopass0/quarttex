      ...
      <Card className="w-full max-w-md p-6 md:p-8 bg-white dark:bg-[#29382f] shadow-lg border-gray-200 dark:border-[#29382f]">
        ...
        <form onSubmit={handleSubmit} className="space-y-4 md:space-y-6">
          <div>
            ...
            <div className="mt-1 relative">
              <Mail className="absolute left-3 top-1/2 transform -translate-y-1/2 text-[#530FAD] dark:text-[#7c3aed] h-4 w-4" />
              <Input
                id="email"
                type="email"
          ...
          <div>
            ...
            <div className="mt-1 relative">
              <Lock className="absolute left-3 top-1/2 transform -translate-y-1/2 text-[#530FAD] dark:text-[#7c3aed] h-4 w-4" />
              <Input
                id="password"
                type="password"
                placeholder="••••••••"
          ...
          <Button
            type="submit"
            className="w-full bg-[#530FAD] hover:bg-[#6d28d9] dark:bg-[#7c3aed] dark:hover:bg-[#6d28d9] h-10 md:h-11 text-sm md:text-base"
            disabled={loading}
          >
            {loading ? (
              <>
        ...
        <div className="mt-4 md:mt-6 text-center text-xs md:text-sm text-gray-600 dark:text-gray-400">
          <p>
            ...
            <a
              href="#"
              className="text-[#530FAD] dark:text-[#7c3aed] hover:text-[#6d28d9] dark:hover:text-[#6d28d9] font-medium"
            >
