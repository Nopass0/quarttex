...
export default function TraderLoginPage() {
  ...
  return (
    <div className="min-h-screen bg-purple-50/30 dark:bg-[#0f0f0f] flex items-center justify-center p-4">
      <Card className="bg-purple-50/10 w-full max-w-md p-6 md:p-8 bg-purple-50/20 dark:bg-purple-900/15 dark:bg-purple-800/60 shadow-lg border-purple-200/60 dark:border-purple-700/60">
        ...
        <form onSubmit={handleSubmit} className="space-y-4 md:space-y-6">
          <div>
            ...
            <div className="mt-1 relative">
              <Mail className="absolute left-3 top-1/2 transform -translate-y-1/2 text-[#530FAD] dark:text-[#2d6a42] h-4 w-4" />
              <Input
                id="email"
                type="email"
          ...
          <div>
            ...
            <div className="mt-1 relative">
              <Lock className="absolute left-3 top-1/2 transform -translate-y-1/2 text-[#530FAD] dark:text-[#2d6a42] h-4 w-4" />
              <Input
                id="password"
                type="password"
                placeholder="••••••••"
          ...
          <Button
            type="submit"
            className="w-full bg-[#530FAD] hover:bg-purple-700/80 dark:bg-purple-800/60 dark:hover:bg-purple-800/60 h-10 md:h-11 text-sm md:text-base"
            disabled={loading}
          >
            {loading ? (
              <>
        ...
        <div className="mt-4 md:mt-6 text-center text-xs md:text-sm text-gray-600 dark:text-gray-400">
          <p>
            Нет аккаунта?{" "}
            <a href="#" className="text-[#530FAD] dark:text-[#2d6a42] hover:text-[#3d0b80] dark:hover:text-[#236035] font-medium">
