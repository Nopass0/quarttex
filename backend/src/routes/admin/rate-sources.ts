...
export default (app: Elysia) =>
  app
    ...
    .get('/rate-sources/:id', async ({ params: { id } }) => {
    ...
    .post('/rate-sources/:id/traders/:traderId', async ({ params: { id, traderId } }) => {
      try {
    ...
    .delete('/rate-sources/:id/traders/:traderId', async ({ params: { id, traderId } }) => {
      try {
        const updated = await db.user.update({
          where: { id: traderId },
          data: {
    ...
    .post('/rate-sources/:id/merchants/:merchantId', async ({ params: { id, merchantId }, body }) => {
    ...
    .put('/rate-sources/merchants/:relationId', async ({ params: { relationId }, body }) => {
    ...
    .delete('/rate-sources/merchants/:relationId', async ({ params: { relationId } }) => {
      try {
    ...
    .get('/rate-sources/merchant/:merchantId', async ({ params: { merchantId } }) => {
